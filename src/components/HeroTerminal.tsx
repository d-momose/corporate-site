...
const LINES: { text: string; type: LineType }[] = [
  ...
  { text: "", type: "empty" },
  { text: "😊  Delight  for  Everyone", type: "brand" },
  { text: "Connecting...", type: "dim" },
  { text: "", type: "empty" },
  { text: "[✓] あなたの想いを受け取りました 💭", type: "ok" },
  { text: "[✓] 課題が、可能性へと変わりました 💡", type: "ok" },
  { text: "[✓] 笑顔に向けて、全力で走ります 🔥", type: "ok" },
  { text: "[✓] ともに歩む準備が整いました 🤝", type: "ok" },
  { text: "", type: "empty" },
  { text: "$ run --with=delight 🎉", type: "cmd" },
  { text: "", type: "empty" },
